...
trait ManagesApiScopes
{
    ...
    protected array $availableScopes = [
        ...
        'bipot:read'            => 'Semua endpoint bipot (read)',
        'bipot:write'           => 'Semua endpoint bipot (create/update/delete)',
        'bipot:angkatan'        => 'Bipot — list per angkatan',
        'bipot:rincian'         => 'Bipot — rincian biaya per prodi & tahun',
